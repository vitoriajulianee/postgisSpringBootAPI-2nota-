...
public class MunicipioController {
    ...
    public List<MunicipioVO> municipiosVizinhos(@PathVariable String nome){
     ...
     @GetMapping("/municipiosDentroDeUmEstado/{nome}")
    public List<MunicipioVO> municipiosDentroDeUmEstado(@PathVariable String nome){
        List<MunicipioVO> result = repository.listarMunicipiosDentroDeUmEstado(nome);
        return result;
    }
